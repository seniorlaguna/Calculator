...
class ScientificSettingsFragment : PreferenceFragmentCompat(), Preference.OnPreferenceChangeListener, Preference.OnPreferenceClickListener {
    ...
    private fun initOnPreferenceChangeListener() {
        listOf<Preference?>(
            findPreference(getString(R.string.prefs_scientific_calculator_decimal_places_key)),
            findPreference(getString(R.string.prefs_scientific_calculator_history_length_key)),
            findPreference(getString(R.string.prefs_scientific_calculator_precision_key))
        ).forEach {
    ...
    private fun initOnPreferenceClickListener() {
        listOf<Preference?>(
            findPreference<Preference>(getString(R.string.prefs_scientific_calculator_history_clear_key))
        ).forEach {
